...
@Data
@Slf4j
public class CRMSysUserDataTest {
    ...
    public String readFileContent(String fileName) throws ParseException {
        ...
        try {
            ...
            while ((tempStr = reader.readLine()) != null) {
                ...
                System.out.println(stringArray[0] + DELIMITER + stringArray[1] + DELIMITER + DecryptCrmPassword.decrypt(stringArray[2], "1a2!3344bbfjsl#$") + DELIMITER + stringArray[3]);
            }
            reader.close();
            return sbf.toString();
        } catch (IOException e) {
...
//        System.out.println(URLDecoder.decode(convertPercent(tempStr.substring(tempStr.indexOf(SEM_3_STR), tempStr.indexOf("HTTP/1.1") - 1))));
        CRMSysUserDataTest semTest = new CRMSysUserDataTest();
        File file = new File("D:\\test\\sys_user_h.csv");
