...
public class UploadUtils {
    ...
    public static String generateMonthDayName() {
        return getFastDateFormatInstance(YEAR_MONTH_DAY_FORMAT).format(Calendar.getInstance().getTime());
    }
    ...
    public static void main(String[] args) {
        ...
        File file = UploadUtils.getUniqueFile(new File("D:/test/nginx/1.gif"));
        System.out.println(file.getName());

        System.out.println(UploadUtils.generateMonthDayName());
    }
