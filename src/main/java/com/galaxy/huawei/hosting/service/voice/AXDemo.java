package com.galaxy.huawei.hosting.service.voice;

import com.galaxy.huawei.hosting.service.voice.demo.IAXInterfaceDemo;
import com.galaxy.huawei.hosting.service.voice.demo.impl.AXInterfaceDemoImpl;
...
public class AXDemo {
     ...
     */
    private final static String OMPAPPKEY = "7AZyiNcGv1Fh1OcHtA5MyByh51iD"; // APP_Key
    private final static String OMPAPPSECRET = "69yKlQ2f6llKB832vm0iVzR8623d"; // APP_Secret
