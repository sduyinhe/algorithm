...
<mapper namespace="com.jdhn.ecs.repository.${prefix}.command.${modelName}CommandMapper">
    <insert id="save" parameterType="com.jdhn.ecs.model.${prefix}.${modelName}" useGeneratedKeys="true" keyProperty="id">
