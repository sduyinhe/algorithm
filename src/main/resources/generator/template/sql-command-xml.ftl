...
<mapper namespace="com.cheche.crm.repository.${prefix}.command.${modelName}CommandMapper">
    <insert id="save" parameterType="com.cheche.crm.model.${prefix}.${modelName}" useGeneratedKeys="true" keyProperty="id">
